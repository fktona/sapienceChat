...
export const AuthFunction  =  () =>{
  ...
  const mutation  = useMutation<AuthResponse, Error, { userData: AuthRequest; type: string, nextRoute?:string
   }, unknown>({
  ...
  onSuccess: async (data: AuthResponse, variables: { userData: AuthRequest; type: string , nextRoute?:string}) => {
